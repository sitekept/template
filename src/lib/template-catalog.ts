...
const templateCatalogSource = [
  ...
  },
  {
    ...
    href: "/alex-spa-massage",
    name: "Alex Spa Massage",
    sector: "Bien-être",
    structure: "Multi-page service",
    archetype: "Spa local premium multilingue",
    navModel: "Header fixe + langue + CTA appel",
    motionProfile: "Interactions sobres, carousel avis et ancrages fluides",
    shapeLanguage: "Angles 6px, contrastes brun/noir, accents cuivre",
    pageModel: "Landing longue avec soins, avis Google, carte et contact",
    primaryCta: "Ouvrir la page",
    previewImage: "/alex-spa-massage/google-studio.jpg",
    status: "Lab",
    description:
      "Preview privée pour un institut de massage à Paphos, avec contenu multilingue, tarifs issus des photos Google et route d'avis officielle.",
    adminStatus: "admin-only",
    adminNote: "Preview Vercel privée, non affichée sur sitekept.com.",
  },
  {

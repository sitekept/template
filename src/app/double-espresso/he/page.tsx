import { ArrowUpLeft, MapPin, Navigation, Phone, Utensils } from "lucide-react";
...
export default function DoubleEspressoHebrewPage() {
  return (
    <main dir="rtl">
      <div dir="ltr">
        <ScrollExpandMedia
          ...
          title="דאבל אספרסו יפו"
          date="שני בתי קפה, תפריט אחד"
          scrollToExpand="גללו לפתיחת בית הקפה"
        >
          <section
            className="grid gap-8 border border-white/12 bg-[#5a3a2b] p-5 text-white sm:p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-10"
            dir="rtl"
          >
            <div>
              <p className="text-sm font-black text-[#e7b85a]">
                קפה, בראנץ׳ ומטבח מלא ביפו
              </p>
              <h1
              ...
              >
                אתר מוכן לשימוש עבור שני בתי הקפה של דאבל אספרסו.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
                תפריט אחד משותף, שתי כתובות קרובות ביפו, תמונות אמיתיות, שיחות
                ישירות וניווט מהיר. בנוי להפוך תנועה מגוגל מפות לביקורים.
              </p>
                ...
                return (
                  ...
                  >
                    <span className="flex items-start justify-between gap-4">
                      ...
                      <ArrowUpLeft className="size-5 shrink-0 text-[#5fc2b4] transition group-hover:-translate-x-1 group-hover:-translate-y-1" />
                    </span>
                    <span className="text-sm leading-6 text-white/62">
                      אותו תפריט בבית הקפה הזה.
                    </span>
                  </Link>
                );
              })}
      ...
      <section className="bg-[#f7f1e6] px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 border-b border-[#d9cab5] pb-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-end">
            <SectionHeader
              eyebrow="מנות פופולריות"
              title="אוכל, קפה וצלחות עם התפריט המלא מאחוריהן."
              description={`תפריט מלא של ${doubleEspressoMenuStats.itemCount} פריטים נמצא במרחק קליק אחד, והעמוד הראשי מציג קודם את המנות שהלקוח מבין מיד.`}
            />
            <div className="max-w-xl lg:justify-self-end">
              <p className="text-sm leading-7 text-[#57493d]">
                העיצוב מציג את המנות בצורה חמה ומערכתית, בלי להפוך את בית הקפה
                לרשימת מידע יבשה. המחירים גלויים, שמות הפריטים נשארים בעברית,
                וכל כרטיס מוביל לתפריט המלא.
              </p>
              <div className="mt-6">
                <ActionLink
                  href="/double-espresso/he/menu"
                  ...
                  className="tracking-[0.02em]"
                >
                  התפריט המלא <ArrowUpLeft className="size-4" />
                </ActionLink>
              </div>
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="relative min-h-72 overflow-hidden bg-[#5a3a2b]">
                    ...
                    <p className="absolute right-5 bottom-5 text-xs font-black tracking-[0.04em] text-[#fffaf0] uppercase">
                      {featuredImageCaptions[index] ?? "מהמטבח"}
                    </p>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="mt-4 text-xs font-black tracking-[0.04em] text-[#a57245] uppercase">
                      {item.section}
                    </p>
                    {item.description ? (
        ...
        <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
          <div className="relative min-h-[540px] bg-[#5a3a2b] lg:min-h-[720px]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-10">
              <p className="text-xs font-black tracking-[0.04em] text-[#d7b16d] uppercase">
                {doubleEspressoGalleryCaptions.he.diningRoom}
              </p>
              <p
                className="mt-4 max-w-lg text-4xl leading-none font-black sm:text-5xl"
                style={{ fontFamily: "var(--font-double-display)" }}
              >
                התמונות המקומיות מעבירות את האווירה.
              </p>
            </div>
          </div>
          ...
          <div className="px-4 py-20 sm:px-8 lg:px-12 lg:py-28">
            <div className="mx-auto max-w-2xl">
              <SectionHeader
                eyebrow="גלריית בית הקפה"
                title="קצב עמוד חם יותר מתבנית רגילה."
                description="תמונות גדולות, קווים עדינים וטקסט קצר נותנים לבית הקפה תחושה מבוססת, בלי לוותר על שימושיות."
              />
              ...
              <div className="mt-10 border-t border-[#d9cab5] pt-8">
                <ActionLink
                  ...
                  className="tracking-[0.02em]"
                >
                  על בית הקפה <ArrowUpLeft className="size-4" />
                </ActionLink>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#5a3a2b] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
            <SectionHeader
              eyebrow="בואו לבקר"
              title="שני בתי קפה קרובים, בנויים להחלטה מהירה."
              description="שעות פתיחה, טלפונים וניווט גלויים בלי לגרום ללקוחות לחפש בעמוד."
              inverted
            />
                  ...
                  <article key={location.id} className="bg-[#6a4635]">
                    <div className="relative min-h-72 overflow-hidden bg-[#4a3024]">
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-5">
                        <p className="text-xs font-black tracking-[0.04em] text-[#d7b16d] uppercase">
                          {doubleEspressoGalleryCaptions.he.sameMenu}
                        </p>
                    ...
                    <div className="p-5">
                      <div className="grid gap-4 border-y border-white/12 py-5 text-sm text-white/68">
                        <p className="flex items-center gap-3">
                          ...
                          {doubleEspressoGalleryCaptions.he.telAvivYafo}
                        </p>
                        <p className="flex items-center gap-3">
                      ...
                      <p className="mt-5 text-sm leading-6 text-white/62">
                        {locationCopy.hours}. {locationCopy.note}
                      </p>
